...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Xiahl', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '黄鹤一去不复返，白云千载空悠悠', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xiahonglin.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Xiahl, 博客', // 网站关键词 英文逗号隔开
